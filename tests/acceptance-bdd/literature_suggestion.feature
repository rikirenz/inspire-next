...
Feature: Literature Suggestions
  ...
  Examples: Vertical
    | input | dummy:10.1086/305772 | state-doi
  ...
  Scenario: Submit thesis and verify record detail in the list page
    Given I am logged in
    When I go to the literature suggestion page
    And I click on the button Skip, and uncollapse all panels
    And I select the value thesis in the select box with id type_of_doc
    ...
    And I click on the button link with text Add another author
    ...
    And I click on the button link with text Show abstract
  ...
  Scenario: Submit thesis and verify record detail in the detail page
    Given I am logged in
    When I go to the literature suggestion page
    And I click on the button Skip, and uncollapse all panels
    And I select the value thesis in the select box with id type_of_doc
