...
@scenario('literature_suggestion.feature', 'Submit article and verify record detail in the list page')
...
@scenario('literature_suggestion.feature', 'Submit thesis and verify record detail in the list page')
def test_verify_thesis_record_in_the_list_page():
    pass


@scenario('literature_suggestion.feature', 'Submit thesis and verify record detail in the detail page')
...
def click_skip_and_fill_manually():
    ...
    Arsenic().get_element_with_locator(CL.CONFERENCE_TAB).click()
...
@when('I should see the record in the list page')
...
@when('I click on the button link with text Show abstract')
def click_abstract_link_button():
